...
import static de.topicmapslab.tmql4j.draft2011.path.grammar.productions.ValueExpression.TYPE_BOOLEAN;
import static de.topicmapslab.tmql4j.draft2011.path.grammar.productions.ValueExpression.TYPE_CONTENT;
import static de.topicmapslab.tmql4j.draft2011.path.grammar.productions.ValueExpression.TYPE_FUNCTION_INVOCATION;
import static de.topicmapslab.tmql4j.draft2011.path.grammar.productions.ValueExpression.TYPE_INFIX_OPERATOR;
import static de.topicmapslab.tmql4j.draft2011.path.grammar.productions.ValueExpression.TYPE_PREFIX_OPERATOR;
...
import de.topicmapslab.tmql4j.draft2011.path.util.QueryMatchUtils;
