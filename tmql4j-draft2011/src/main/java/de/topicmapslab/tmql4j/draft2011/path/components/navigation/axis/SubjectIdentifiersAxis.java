...
/**
 * Class definition representing the subject-identifiers axis.
 * <p>
 * If the value is a topic item, this step retrieves all subject indicators of this item. The optional item has no
 * relevance.
 * </p>
 * 
 * @author Sven Krosse
 ...
 * 
 */
public class SubjectIdentifiersAxis extends Axis {

	/**
	 * base constructor to create an new instance
	 */
	public SubjectIdentifiersAxis() {
		super(AxisSubjectIdentifiers.class);
	}
