...
public class AssociationPattern extends ExpressionImpl {
	 ...
	 */
	public AssociationPattern(IExpression parent, List<Class<? extends IToken>> tmqlTokens, List<String> tokens, ITMQLRuntime runtime) throws TMQLInvalidSyntaxException, TMQLGeneratorException {
