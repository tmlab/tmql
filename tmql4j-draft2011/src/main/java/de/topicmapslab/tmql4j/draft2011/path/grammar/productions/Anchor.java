...
public class Anchor extends ExpressionImpl {
	 ...
	 */
	public static final int TYPE_PREPARED = 5;
	...
	public Anchor(IExpression parent, List<Class<? extends IToken>> tmqlTokens, List<String> tokens, ITMQLRuntime runtime) throws TMQLInvalidSyntaxException, TMQLGeneratorException {
		...
		} else if (token.equals(de.topicmapslab.tmql4j.draft2011.path.grammar.lexical.Variable.class)) {
	...
	public boolean isValid() {
		...
		Class<? extends IToken> token = getTmqlTokens().get(0);
		return token.equals(Dot.class) || token.equals(de.topicmapslab.tmql4j.draft2011.path.grammar.lexical.Variable.class) || token.equals(Element.class) || token.equals(Literal.class)
