...
import static de.topicmapslab.tmql4j.draft2011.path.grammar.productions.FilterPostfix.TYPE_BOOLEAN_EXPRESSION;
import static de.topicmapslab.tmql4j.draft2011.path.grammar.productions.FilterPostfix.TYPE_BOUNDS_FILTER;
import static de.topicmapslab.tmql4j.draft2011.path.grammar.productions.FilterPostfix.TYPE_INDEX_FILTER;
import static de.topicmapslab.tmql4j.draft2011.path.grammar.productions.FilterPostfix.TYPE_SCOPE_FILTER;
import static de.topicmapslab.tmql4j.draft2011.path.grammar.productions.FilterPostfix.TYPE_SHORTCUT_BOUNDS_FILTER;
import static de.topicmapslab.tmql4j.draft2011.path.grammar.productions.FilterPostfix.TYPE_SHORTCUT_INDEX_FILTER;
import static de.topicmapslab.tmql4j.draft2011.path.grammar.productions.FilterPostfix.TYPE_SHORTCUT_SCOPE_FILTER;
import static de.topicmapslab.tmql4j.draft2011.path.grammar.productions.FilterPostfix.TYPE_SHORTCUT_TYPE_FILTER;
import static de.topicmapslab.tmql4j.draft2011.path.grammar.productions.FilterPostfix.TYPE_TYPE_FILTER;
