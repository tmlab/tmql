...
public class Parameters extends ExpressionImpl {
	...
	public Parameters(IExpression parent, List<Class<? extends IToken>> tmqlTokens, List<String> tokens, final ITMQLRuntime runtime) throws TMQLInvalidSyntaxException, TMQLGeneratorException {
		...
		if (index != -1) {
			...
			IParserUtilsCallback callback = new IParserUtilsCallback() {
				...
				public void newToken(List<Class<? extends IToken>> tmqlTokens, List<String> tokens, Class<? extends IToken> foundDelimer) throws TMQLGeneratorException, TMQLInvalidSyntaxException {
					checkForExtensions(ParameterPair.class, tmqlTokens, tokens, runtime);
				}
			};
