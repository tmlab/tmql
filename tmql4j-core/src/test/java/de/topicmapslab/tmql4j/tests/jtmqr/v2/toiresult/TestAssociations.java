package de.topicmapslab.tmql4j.tests.jtmqr.v2.toiresult;
...
public class TestAssociations extends AbstractTest {
	...
	public void testId() {
		...
		Association construct = map.createAssociation(map.createTopicBySubjectIdentifier(map.createLocator(typeSi)));
		construct.createRole(map.createTopic(), map.createTopic());
