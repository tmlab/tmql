...
/**
 * Author: mhoyer Created: 28.10.2010 09:53:25
 */
public class when_writing_a_single_tuple_of_literals extends with_JTMQRWriter {
	...
	public void it_should_write_tuple_items_as_string_literal() {
		assertEquals(getClass().getName(), tupleNode.get(0).get("s").getTextValue());
		assertEquals(getClass().getSimpleName(), tupleNode.get(1).get("s").getTextValue());
	}
}
