...
public final class CollectionsUtility {
	...
	/**
	 * Method reduces the given collection to a real two dimensional collection.
	 * In meaning, if the collection contains other collections, their content
	 * will be added. If this content is also a collection, it will be added its
	 * content too, a.s.o.
	 * 
	 * @param obj
	 *            the collection
	 ...
	 */
	@SuppressWarnings("unchecked")
	public final static Collection<?> asTwoDimension(Collection<Object> obj) {
		List<Object> list = new LinkedList<Object>();
		for (Object o : obj) {
			if (o instanceof Collection<?>) {
				list.addAll(asTwoDimension((Collection<Object>) o));
			} else {
				list.add(o);
			}
		}
