 ...
 * 
 */
public class Draft2007MergeStyle implements IExtensionPoint {

	/**
	 * constant extension point id
	 */
	private static final String DRAFT2007_MERGE_STYLE = "draft2007-merge-style";
	...
	public void registerExtension(ITMQLRuntime runtime) throws TMQLExtensionRegistryException {
		...
		Draft2007MergeQueryExpression draft2007FlwrStyleQueryExpression = new Draft2007MergeQueryExpression();
