 ...
 * 
 */
public class PrefixDirective extends ExpressionImpl {
	 ...
	 */
	public PrefixDirective(IExpression parent, List<Class<? extends IToken>> tmqlTokens, List<String> tokens, ITMQLRuntime runtime) throws TMQLInvalidSyntaxException, TMQLGeneratorException {
