...
/**
 * Special implementation of {@link ExpressionImpl} representing a where-clause.
 * <p>
 ...
 * 
 */
public class WhereClause extends ExpressionImpl {
	 ...
	 */
	public WhereClause(IExpression parent, List<Class<? extends IToken>> tmqlTokens, List<String> tokens, ITMQLRuntime runtime) throws TMQLInvalidSyntaxException, TMQLGeneratorException {
	...
	public boolean isValid() {
		/*
		 * at least two tokens expected beginning with the keyword WHERE
		 */
