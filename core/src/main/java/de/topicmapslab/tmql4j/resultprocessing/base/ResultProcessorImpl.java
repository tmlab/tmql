 ...
 * 
 */
public class ResultProcessorImpl implements IResultProcessor {

	/**
	 * the class of generated {@link IResultSet}
	 */
	private final Class<? extends IResultSet<?>> clazz;
	/**
	 ...
	 */
	public <T extends IResult> ResultProcessorImpl(final ITMQLRuntime runtime,
			final Class<? extends IResultSet<T>> clazz) {
	...
	public void proceed(QueryMatches matches) throws TMQLRuntimeException {
		try {
			...
			/*
			 * check if query matches should be unique
			 */
			if (runtime.getProperties().newSequence().isUniqueSet()) {
				/*
				 * unify query matches
				 */
