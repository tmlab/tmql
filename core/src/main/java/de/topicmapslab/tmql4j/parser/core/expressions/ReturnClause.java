...
public class ReturnClause extends ExpressionImpl {
	 ...
	 */
	public ReturnClause(IExpression parent,
		...
		if (getTmqlTokens().get(0).equals(Return.class)) {
			 ...
			 */
			checkForExtensions(Content.class, tmqlTokens.subList(1, tmqlTokens
	...
	public boolean isValid() {
		...
		return getTmqlTokens().size() > 1
				&& (getTmqlTokens().get(0).equals(Return.class) || getTmqlTokens()
						.get(0).equals(XmlStartTag.class));
	}
}
