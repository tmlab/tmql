...
public class QueryExpression extends ExpressionImpl {
	 ...
	 * 
	 */
	public QueryExpression(ILexer lexer, TMQLRuntime runtime)
	...
	public QueryExpression(IExpression parent,
		 ...
		 */
		if (token.equals(de.topicmapslab.tmql4j.lexer.token.Pragma.class)
			...
			indizes = ParserUtils.indizes(tmqlTokens,
					de.topicmapslab.tmql4j.lexer.token.Prefix.class);
