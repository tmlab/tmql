 ...
 *
 */
package de.topicmapslab.tmql4j.navigation.model;
...
public interface INavigationAxis {
	...
	/**
	 * Method returns the internal stored instance of the topic map representing
	 * the environment map of TMQL. The topic map instance will be used during
	 ...
	 *             thrown if topic map reference is <code>null</code>
	 */
	TopicMap getEnvironment() throws NavigationException;

	/**
	 * Method changes the internal instance of the topic map representing the
	 * environment map of TMQL and set it to the given value. The topic map
	 * instance will be used during the navigation process.
	 * 
	 * @param topicMap
	 *            the new topic map reference
	 */
	void setEnvironment(TopicMap topicMap);
	 ...
	 */
	boolean supportsBackwardNavigation(final Object construct)
			throws NavigationException;
	 ...
	 */
	boolean supportsBackwardNavigation(final Object construct,
			final Construct optional) throws NavigationException;
	 ...
	 *             thrown if support cannot be checked
	 */
	boolean supportsForwardNavigation(final Object construct)
			throws NavigationException;
	 ...
	 */
	boolean supportsForwardNavigation(final Object construct,
			final Object optional) throws NavigationException;
	 ...
	 */
	Collection<?> navigateBackward(final Object construct)
			throws NavigationException;
	 ...
	 *             thrown if navigation fails, because of unsupported types
	 */
	Collection<?> navigateForward(final Object construct)
			throws NavigationException;
	 ...
	 *             thrown if navigation fails, because of unsupported types
	 */
	Collection<?> navigateForward(final Object construct, final Object optional)
			throws NavigationException;
	 ...
	 *             thrown if navigation fails, because of unsupported types
	 */
	Class<?> getBackwardNavigationResultClass(final Object construct)
			throws NavigationException;
	 ...
	 *             thrown if navigation fails, because of unsupported types
	 */
	Class<?> getForwardNavigationResultClass(final Object construct)
			throws NavigationException;
}
