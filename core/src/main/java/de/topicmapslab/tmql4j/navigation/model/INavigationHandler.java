...
public interface INavigationHandler {
	 ...
	 *             navigation failed
	 */
	Collection<INavigationAxis> getSupportedNavigationAxis(
			final Construct construct) throws NavigationException;
	 ...
	 */
	Collection<INavigationAxis> getSupportedNavigationAxis(
			final Construct construct, final Construct optional)
			throws NavigationException;
	 ...
	 */
	INavigationAxis lookup(final NavigationAxis type)
			throws UnsupportedNavigationTypeException;
