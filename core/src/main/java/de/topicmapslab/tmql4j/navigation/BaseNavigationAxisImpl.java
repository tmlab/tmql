...
public abstract class BaseNavigationAxisImpl implements INavigationAxis {
	...
	/**
	 * the internal environment map
	 */
	private TopicMap environment;
	 ...
	 * {@inheritDoc}
	 */
	public Collection<?> navigateForward(Object construct)
			throws NavigationException {
	 ...
	 * {@inheritDoc}
	 */
	public boolean supportsForwardNavigation(Object construct)
			throws NavigationException {
	 ...
	 * {@inheritDoc}
	 */
	public void setEnvironment(TopicMap topicMap) {
		this.environment = topicMap;
	 ...
	 * {@inheritDoc}
	 */
	public TopicMap getEnvironment() throws NavigationException {
		if (environment == null) {
			throw new NavigationException("environment map not set!");
		}
		return environment;
	}
