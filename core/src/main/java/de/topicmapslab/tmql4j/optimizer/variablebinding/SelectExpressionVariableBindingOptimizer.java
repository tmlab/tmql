 ...
 * select-expressions. The variable bindings are ordered in a way that
 ...
 * 
 */
public class SelectExpressionVariableBindingOptimizer extends
		VariableBindingOptimizer<SelectExpression> {
	 ...
	 *            the TMQL runtime
	 */
	public SelectExpressionVariableBindingOptimizer(TMQLRuntime runtime) {
		super(runtime);
	 ...
	 */
	@Override
	protected Set<?> optimize(SelectExpression expression, String variable)
			throws TMQLOptimizationException {
		try {
			/*
			 * check if select-expression contains a where-clause
			 */
