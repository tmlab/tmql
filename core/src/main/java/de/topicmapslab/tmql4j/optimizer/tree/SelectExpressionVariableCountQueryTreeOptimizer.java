...
/**
 * Special implementation of query tree optimizer for select-expressions
 ...
 * 
 */
public class SelectExpressionVariableCountQueryTreeOptimizer
		extends VariableCountQueryTreeOptimizer<SelectExpression> {

	/**
	 * {@inheritDoc}
	 */
	public SelectExpression optimize(SelectExpression expression)
