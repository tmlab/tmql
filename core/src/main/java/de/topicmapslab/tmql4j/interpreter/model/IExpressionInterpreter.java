...
public interface IExpressionInterpreter<T extends IExpression> {
	...
	/**
	 * Main method of each interpreter instance. The method is called to
	 * interpret the given expression by using the given runtime. The
	 * interpretation will call sub-expression if the given expression isn't a
