...
public class Environment {
	...
	public Environment(TMQLRuntime runtime, TopicMap environmentMap)
		...
		tmql_occurrences_precedence.addSubjectIdentifier(map
	...
	private final void createFunctionsAndOperatorsAsTopics() throws Exception {
		...
		tmql_unary_operator.addSubjectIdentifier(map.createLocator(tmql4j_qname
				+ "tmql_unary_operator"));
		...
		tmql_prefix_operator
				.createName("Prefix (unary) operator", new Topic[0]);
		...
		tmql_string_length_function.addSubjectIdentifier(map
		...
		tmql_string_length_function.createName("String length", new Topic[0]);
		tmql_string_length_function.isa(tmql_function);
		tmql_string_length_function.createOccurrence(tmql_occurrences_pattern,
				"+", new Topic[0]);
		tmql_string_length_function.createOccurrence(tmql_occurrences_profile,
		...
		tmql_string_less_than_binary_operator.createName("String less than",
				new Topic[0]);
		...
		tmql_string_less_equal_than_binary_operator.addSubjectIdentifier(map
				.createLocator(tmql4j_qname
		...
		tmql_string_less_equal_than_binary_operator.isa(tmql_binary_operator);
		...
		tmql_string_greater_equal_than_binary_operator.addSubjectIdentifier(map
				.createLocator(tmql4j_qname
		...
		tmql_string_greater_equal_than_binary_operator.addItemIdentifier(map
				.createLocator("fn:string-geq"));
		...
		tmql_has_datatype_function.addSubjectIdentifier(map
		...
		tmql_has_datatype_function.createOccurrence(tmql_occurrences_profile,
				"fn:has-datatype (s: tuple-sequence) return tuple-sequence",
				new Topic[0]);
		...
		tmql_has_variant_function.createOccurrence(tmql_occurrences_profile,
		...
		tmql_slice_function.addSubjectIdentifier(map.createLocator(tmql4j_qname
				+ "tmql_slice_function"));
		tmql_slice_function
				.addSubjectIdentifier(map
						.createLocator("http://psi.topicmaps.org/tmql/1.0/functions/slice"));
		tmql_slice_function.addItemIdentifier(map.createLocator("fn:slice"));
		...
		tmql_count_function.addSubjectIdentifier(map.createLocator(tmql4j_qname
				+ "tmql_count_function"));
		tmql_count_function
				.addSubjectIdentifier(map
						.createLocator("http://psi.topicmaps.org/tmql/1.0/functions/count"));
		tmql_count_function.addItemIdentifier(map.createLocator("fn:count"));
		...
		tmql_count_function.createOccurrence(tmql_occurrences_profile,
				"fn:count (s : tuple-sequence) return integer", new Topic[0]);
		/*
		...
		tmql_uniq_function.addSubjectIdentifier(map.createLocator(tmql4j_qname
				+ "tmql_uniq_function"));
		tmql_uniq_function
				.addSubjectIdentifier(map
		...
		tmql_concat_binary_operator.addSubjectIdentifier(map
		...
		tmql_concat_binary_operator.createOccurrence(tmql_occurrences_pattern,
				"++", new Topic[0]);
		tmql_concat_binary_operator
				.createOccurrence(
						tmql_occurrences_profile,
		...
		tmql_except_binary_operator.addSubjectIdentifier(map
		...
		tmql_except_binary_operator.createOccurrence(
				tmql_occurrences_precedence, "1", new Topic[0]);
		tmql_except_binary_operator.createOccurrence(tmql_occurrences_pattern,
				"--", new Topic[0]);
		tmql_except_binary_operator
				.createOccurrence(
						tmql_occurrences_profile,
		...
		tmql_compare_binary_operator.createOccurrence(
				tmql_occurrences_precedence, "1", new Topic[0]);
		tmql_compare_binary_operator.createOccurrence(tmql_occurrences_pattern,
				"==", new Topic[0]);
		tmql_compare_binary_operator
				.createOccurrence(
						tmql_occurrences_profile,
		...
		tmql_zigzag_function.addItemIdentifier(map.createLocator("fn:zigzag"));
		...
		tmql_zagzig_function.addItemIdentifier(map.createLocator("fn:zagzig"));
	...
	private final void createDatatypesAsTopics() throws Exception {
		...
		tmql_primitive_datatype.createName("Primitive Data Type", new Topic[0]);
		...
		tmql_datatype_undefined.createName("Undefined Data Type", new Topic[0]);
		tmql_datatype_undefined.isa(tmql_primitive_datatype);

		tmql_topic_undef = map.createTopic();
		tmql_topic_undef.addSubjectIdentifier(map.createLocator(tmql4j_qname
		...
		tmql_datatype_iri.addSubjectIdentifier(map.createLocator(tmql4j_qname
				+ "tmql_datatype_iri"));
		tmql_datatype_iri
				.addSubjectIdentifier(map
		...
		tmql_datatype_date.addSubjectIdentifier(map.createLocator(tmql4j_qname
				+ "tmql_datatype_date"));
		tmql_datatype_date
				.addSubjectIdentifier(map
		...
		tmql_datatype_xml.addSubjectIdentifier(map.createLocator(tmql4j_qname
				+ "tmql_datatype_xml"));
		...
		tmql_datatype_tuple.addSubjectIdentifier(map.createLocator(tmql4j_qname
				+ "tmql_datatype_tuple"));
		...
		tmql_datatype_tuple_sequence.createName("Tuple Sequence", new Topic[0]);
