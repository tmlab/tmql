 ...
 * 
 */
public class StringLeqFunctionInvocationInterpreter extends
	 ...
	 */
	public StringLeqFunctionInvocationInterpreter(FunctionInvocation ex) {
		super(ex);
	}
			...
			try {
				...
				if (s instanceof Collection<?>) {
					...
					for (Object obj : (Collection<?>) s) {
						/*
						 * add only literals which are lower or equal
						 */
						if (ComparisonUtils.isLowerOrEquals(obj, b)) {
				 ...
				 * add only literals which are lower or equal
				 */
				else if (ComparisonUtils.isLowerOrEquals(s, b)) {
