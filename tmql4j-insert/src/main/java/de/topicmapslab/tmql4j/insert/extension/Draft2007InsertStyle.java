 ...
 * 
 */
public class Draft2007InsertStyle implements IExtensionPoint {

	/**
	 * constant extension point id
	 */
	private static final String DRAFT2007_INSERT_STYLE = "draft2007-insert-style";
	...
	public void registerExtension(ITMQLRuntime runtime) throws TMQLExtensionRegistryException {
		...
		Draft2007InsertQueryExpression draft2007FlwrStyleQueryExpression = new Draft2007InsertQueryExpression();
