...
public class CTMConverter {
	 ...
	 */
	public static TopicMap toTopicMap(final String ctm, final TopicMapSystem tms) throws TMQLRuntimeException {
		try {
			/*
	 ...
	 */
	public static String toCTMString(Collection<?> values) throws TMQLRuntimeException {
