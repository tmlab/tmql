...
import de.topicmapslab.tmql4j.insert.exceptions.UpdateException;
import de.topicmapslab.tmql4j.insert.grammar.tokens.Names;
import de.topicmapslab.tmql4j.insert.grammar.tokens.Occurrences;
...
public class UpdateHandler {
	 ...
	 */
	public UpdateHandler(ITMQLRuntime runtime, IContext context) throws DeletionException {
		try {
