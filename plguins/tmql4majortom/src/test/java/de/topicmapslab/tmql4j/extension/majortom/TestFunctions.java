 ...
 * 
 */
public class TestFunctions extends Tmql4JTestCase {
	...
	public void testGetCoordinatesByDistanceAsDouble() throws Exception {
		...
		query = "SELECT " + GetCoordinatesInDistance.GetCoordinatesInDistanceIdentifier + "( " + coordinate.getLatitude() + " , " + coordinate.getLongitude() + " , 0 )";
		...
		query = "SELECT " + GetCoordinatesInDistance.GetCoordinatesInDistanceIdentifier + "( " + other.getLatitude() + " , " + other.getLongitude() + " , 0 )";
		set = execute(query);
		assertEquals(1, set.size());
		assertEquals(1, set.first().size());
		assertEquals(otherOccurrence, set.first().first());

		query = "SELECT " + GetCoordinatesInDistance.GetCoordinatesInDistanceIdentifier + "( " + other.getLatitude() + " , " + other.getLongitude() + " , " + coordinate.getDistance(other) + " )";
		set = execute(query);
	...
	public void testGetCoordinatesByDistanceAsString() throws Exception {
		...
		query = "SELECT " + GetCoordinatesInDistance.GetCoordinatesInDistanceIdentifier + "( \"" + coordinate.toString() + "\" , 0 )";
		System.out.println(query);
		set = execute(query);
		assertEquals(1, set.size());
		assertEquals(1, set.first().size());
		...
		query = "SELECT " + GetCoordinatesInDistance.GetCoordinatesInDistanceIdentifier + "( \"" + other.toString() + "\" , 0 )";
		set = execute(query);
		assertEquals(1, set.size());
		assertEquals(1, set.first().size());
		assertEquals(otherOccurrence, set.first().first());

		query = "SELECT " + GetCoordinatesInDistance.GetCoordinatesInDistanceIdentifier + "( \"" + coordinate.toString() + "\" , " + coordinate.getDistance(other) + " )";
		set = execute(query);
		assertEquals(2, set.size());
		for (IResult r : set) {
			assertEquals(1, r.size());
	...
	public void testGetCoordinatesByDistanceParent() throws Exception {
		...
		query = "FOR $c IN " + GetCoordinatesInDistance.GetCoordinatesInDistanceIdentifier + "( \"" + coordinate.toString() + "\" , " + coordinate.getDistance(other) + " ) RETURN $c << characteristics";
		set = execute(query);
		assertEquals(2, set.size());
		for (IResult r : set) {
			assertEquals(1, r.size());
	...
	public void testGetDistanceAsDouble() throws Exception {
		...
		query = "SELECT " + GetDistance.GetDistanceIdentifier + "( " + coordinate.getLatitude() + " , " + coordinate.getLongitude() + " , " + coordinate.getLatitude() + " , "
		...
		query = "SELECT " + GetDistance.GetDistanceIdentifier + "( " + other.getLatitude() + " , " + other.getLongitude() + " , " + other.getLatitude() + " , " + other.getLongitude() + " )";
		set = execute(query);
		assertEquals(1, set.size());
		assertEquals(1, set.first().size());
		assertEquals(0D, set.first().first());

		query = "SELECT " + GetDistance.GetDistanceIdentifier + "( " + coordinate.getLatitude() + " , " + coordinate.getLongitude() + " , " + other.getLatitude() + " , " + other.getLongitude() + " )";
		set = execute(query);
		assertEquals(1, set.size());
		assertEquals(1, set.first().size());
		assertEquals(coordinate.getDistance(other), set.first().first());

		query = "SELECT " + GetDistance.GetDistanceIdentifier + "( " + other.getLatitude() + " , " + other.getLongitude() + " , " + coordinate.getLatitude() + " , " + coordinate.getLongitude() + " )";
		set = execute(query);
		assertEquals(1, set.size());
		assertEquals(1, set.first().size());
		assertEquals(coordinate.getDistance(other), set.first().first());
	...
	public void testGetDistanceAsString() throws Exception {
		...
		query = "SELECT " + GetDistance.GetDistanceIdentifier + "( \"" + coordinate.toString() + "\" , \"" + coordinate.toString() + "\" )";
		System.out.println(query);
		set = execute(query);
		assertEquals(1, set.size());
		assertEquals(1, set.first().size());
		...
		query = "SELECT " + GetDistance.GetDistanceIdentifier + "( \"" + other.toString() + "\" , \"" + other.toString() + "\" )";
		set = execute(query);
		assertEquals(1, set.size());
		assertEquals(1, set.first().size());
		assertEquals(0D, set.first().first());

		query = "SELECT " + GetDistance.GetDistanceIdentifier + "( \"" + coordinate.toString() + "\" , \"" + other.toString() + "\" )";
		set = execute(query);
		assertEquals(1, set.size());
		assertEquals(1, set.first().size());
		assertEquals(coordinate.getDistance(other), set.first().first());

		query = "SELECT " + GetDistance.GetDistanceIdentifier + "( \"" + other.toString() + "\" , \"" + coordinate.toString() + "\" )";
		set = execute(query);
		assertEquals(1, set.size());
		assertEquals(1, set.first().size());
		assertEquals(coordinate.getDistance(other), set.first().first());
