...
import de.topicmapslab.tmql4j.tests.environment.EnvironmentTests;
...
import de.topicmapslab.tmql4j.tests.path.PathStyleTests;
import de.topicmapslab.tmql4j.tests.select.SelectStyleTests;
