 ...
 * 
 */
public class ItemAxisTranslator extends IdentityAxisTranslator {

	static final String COLUMN = "id_construct";
	static final String RELATION = "rel_item_identifiers";
