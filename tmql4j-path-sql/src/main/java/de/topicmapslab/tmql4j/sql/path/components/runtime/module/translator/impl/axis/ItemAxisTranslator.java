...
public class ItemAxisTranslator extends AxisTranslatorImpl {
	...
	static final String REL_SUBJECT_IDENTIFIERS = "rel_item_identifiers";

	static final String FORWARD_SELECTION = "reference";
	static final String BACKWARD_SELECTION = "id_construct";

	static final String CONDITION = "{0}.id = {1}.id_locator";
	static final String FORWARD_CONDITION = "{0} = {1}.id_construct";
