...
/**
 * Prepared Statement of the 2010 draft
 * 
 * @author Sven Krosse
 * 
 * @since 3.1.0
 */
public class PreparedStatement2010 extends PreparedStatement {
	 ...
	 *            the tree
	 */
	public PreparedStatement2010(ITMQLRuntime runtime, IQuery query, IParserTree tree) {
